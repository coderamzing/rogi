  ...
  return (
    <>
      ...
      <Tabs defaultValue="current" className="w-full">
        <TabsList className="w-full flex flex-wrap mb-4 grid-cols-4">
          <TabsTrigger value="current" className="flex-1 text-xs sm:text-sm h-full">
            <span className="hidden sm:inline">Current Mortgage</span>
            <span className="sm:hidden">Current</span>
          </TabsTrigger>
          <TabsTrigger value="new" className="flex-1 text-xs sm:text-sm h-full">
            <span className="hidden sm:inline">New Mortgage</span>
            <span className="sm:hidden">New</span>
          </TabsTrigger>
          <TabsTrigger value="property" className="flex-1 text-xs sm:text-sm h-full">
            Property
          </TabsTrigger>
          <TabsTrigger value="summary" className="flex-1 text-xs sm:text-sm h-full">
            Summary
          </TabsTrigger>
        </TabsList>
