            ...
            <NavigationMenuList>
              <NavigationMenuItem>
                <Link href="/" legacyBehavior passHref>
                  <NavigationMenuLink className="text-lg font-semibold text-primary">MortgageCalc</NavigationMenuLink>
                </Link>
              </NavigationMenuItem>
              <NavigationMenuItem>
                <NavigationMenuTrigger className="text-primary hover:bg-secondary hover:text-primary">
                  Tools
                </NavigationMenuTrigger>
                <NavigationMenuContent>
                    ...
                    <li className="row-span-3">
                      <NavigationMenuLink asChild>
                        <Link
                          ...
                          href="/"
                        >
                          <div className="mb-2 mt-4 text-lg font-medium text-primary">Mortgage Calculator</div>
              ...
              <NavigationMenuItem>
                <Link href="/about" legacyBehavior passHref>
                  <NavigationMenuLink className="text-sm text-primary hover:bg-secondary hover:text-primary">
                    About
                  </NavigationMenuLink>
                </Link>
              </NavigationMenuItem>
