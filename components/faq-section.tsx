    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-gilroy-black text-primary mb-4">Frequently Asked Questions</h2>
        ...
        <div className="max-w-3xl mx-auto">
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              <AccordionTrigger className="font-semibold">What is a mortgage pre-approval?</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-2">
              <AccordionTrigger className="font-semibold">How much down payment do I need?</AccordionTrigger>
              <AccordionContent>
          ...
          <div className="text-center mt-8">
            <Button asChild variant="outline" className="border-primary text-primary hover:bg-primary/10 font-semibold">
