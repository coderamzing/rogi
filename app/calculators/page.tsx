...
import { Calculator, Home, RefreshCw, DollarSign, Percent, BarChart, FileText, ArrowLeftRightIcon as ArrowsLeftRight, PiggyBank, Clock, Building, Landmark, Scale, Briefcase, FileCheck, ChevronRight } from "lucide-react"
      ...
      <div className="container py-12">
        ...
        <div className="text-center mb-16 max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600">
            Our comprehensive suite of mortgage calculators and application tools to help you make informed decisions about your mortgage options.
          </p>
        </div>
        ...
        <section className="mb-24">
            ...
            <div className="px-8 py-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {mortgageCalculators.map((calc, index) => (
                  <Card key={index} className="border-0 shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden">
                    <CardHeader className="pb-2 pt-6">
                      <div className="w-14 h-14 rounded-full bg-primary/10 flex items-center justify-center mb-4">
                        {calc.icon}
                      </div>
                    ...
                    <CardFooter className="pt-2 pb-6">
                      <Button asChild className="w-full group-hover:bg-primary/90 transition-colors">
                        <Link href={calc.link}>Calculate Now</Link>
                      </Button>
                    </CardFooter>
                  </Card>
                ))}
          ...
          <div className="mb-16 relative overflow-hidden rounded-3xl">
            ...
            <div className="px-8 py-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {taxAndFeesCalculators.map((calc, index) => (
                  <Card key={index} className="border-0 shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden">
                    <CardHeader className="pb-2 pt-6">
                      <div className="w-14 h-14 rounded-full bg-primary/10 flex items-center justify-center mb-4">
                        {calc.icon}
