      ...
      <main className="flex-grow">
        <div className="bg-white">
          ...
          <div className="container mx-auto px-4 py-16 text-center">
            <h1 className="text-4xl md:text-5xl font-gilroy-black text-primary mb-6">About Us</h1>
            <p className="text-xl font-gilroy-ultralight text-black max-w-3xl mx-auto">
          ...
          <div className="container mx-auto px-4 py-12">
            <div className="flex flex-col md:flex-row items-center gap-12">
              <div className="md:w-1/2">
                <h2 className="text-3xl font-gilroy-black mb-6 text-primary">
                  We're here to make mortgages <span className="text-accent">simple</span> for everyone.
                </h2>
                <p className="text-black mb-6 font-gilroy-ultralight">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                {stats.map((stat, index) => (
                  <div key={index} className="text-center">
                    <div className="text-4xl font-gilroy-black text-primary mb-2">{stat.number}</div>
                    <div className="text-primary font-gilroy-ultralight">{stat.label}</div>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 py-16">
            <h2 className="text-3xl font-gilroy-black text-center mb-12 text-primary">Our Values</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {values.map((value, index) => (
                <div key={index} className="text-center p-6 rounded-lg hover:bg-secondary transition-colors">
                  <div className="flex justify-center mb-4">{value.icon}</div>
                  <h3 className="text-xl font-gilroy-black mb-2 text-primary">{value.title}</h3>
                  <p className="text-black font-gilroy-ultralight">{value.description}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-primary text-white py-16">
            <div className="container mx-auto px-4 text-center">
              <h2 className="text-3xl font-gilroy-black mb-6">Ready to Start Your Journey?</h2>
              <p className="text-lg mb-8 max-w2xl mx-auto font-gilroy-ultralight">
