...
export default function SettingsPage() {
  ...
  // For demo purposes, all save functions just show a timeout and alert
  ...
  const handleSaveNotifications = async () => {
    ...
    alert("Notifications saved in demo mode!")
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-md">
        <p className="text-amber-700 text-sm">Demo Mode - Changes will not be saved permanently</p>
      </div>
