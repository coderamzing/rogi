  ...
  return (
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-md">
        <h2 className="text-amber-800 font-medium">Demo Dashboard</h2>
        <p className="text-amber-700 text-sm">This is a demonstration with sample data. No login required.</p>
      </div>
